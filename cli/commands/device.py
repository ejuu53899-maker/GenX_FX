...
------------------------------------------------------------------------
CONTABO-VPS         ONLINE       192.168.1.100  Cloud Brain Server (4 vCPU / 8GB RAM)
GENX-MINIPC ({telemetry['device']})  {telemetry['status'].upper()}       192.168.1.50   GK3PRO Local Worker (CPU: {telemetry['cpu']}, MT5: {telemetry['mt5'].upper()})
HUAWEI-TXZ-W09      ONLINE       MOBILE         Android Mobile Monitor
...
OS: Ubuntu Server 24.04 LTS (4 vCPU / 8GB RAM)
